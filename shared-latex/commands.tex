...
\newcommand{\VhamiltonianOperatorPart}[4][]{\ensuremath{\hat{\text{F}}_\text{#2}\left(#3,\,#4\right)}^{#1}\xspace}
\newcommand{\VhamiltonianAnalyticalPart}[5][]{\ensuremath{\hat{\Lambda}_\text{#2}\left(#3,\,#4,\,#5\right)}^{#1}\xspace}
