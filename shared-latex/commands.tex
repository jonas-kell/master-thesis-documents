...
\newcommand{\VhamiltonianOfT}[1][]{\ensuremath{\hat{\text{V}}^{#1}(t)}\xspace}
\newcommand{\VhamiltonianOfTPrime}[1][]{\ensuremath{\hat{\text{V}}^{#1}(t')}\xspace} % TODO refactor
\newcommand{\HeffOft}[1][N]{\ensuremath{\hamiltonian_\text{#1}(t)}\xspace}
...
\newcommand{\psiN}{\ensuremath{\varPsi_N}\xspace}
