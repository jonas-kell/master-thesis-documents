...
\newcommand{\HvcnOft}[2][N]{\ensuremath{{\hamiltonian_\text{VCN}}({#1},\,{#2},\,t)}\xspace}
...
\newcommand{\ketpsiEta}[2]{\ensuremath{\ket{\picturePsi[]{_{#1}(#2)}}}\xspace}
...
\newcommand{\biggerNeighborX}[2]{\ensuremath{\left\langle#1 \stackrel{+(\mathrm{x})}{<} #2\right\rangle}\xspace}
\newcommand{\smallerNeighborX}[2]{\ensuremath{\left\langle#1 \stackrel{+(\mathrm{x})}{>} #2\right\rangle}\xspace}
\newcommand{\biggerNeighborY}[2]{\ensuremath{\left\langle#1 \stackrel{+(\mathrm{y})}{<} #2\right\rangle}\xspace}
\newcommand{\smallerNeighborY}[2]{\ensuremath{\left\langle#1 \stackrel{+(\mathrm{y})}{>} #2\right\rangle}\xspace}
