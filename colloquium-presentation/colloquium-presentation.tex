...
\begin{document}
    ...
    \input{main-content/introduction/introduction.tex}
    \input{main-content/time-evolution/time-evolution.tex}
    \input{main-content/simplifications/simplifications.tex}
    \input{main-content/variational-classical-networks/variational-classical-networks.tex}
    \input{main-content/implementation-experiments/implementation-experiments.tex}
    \input{main-content/outlook/outlook.tex}
