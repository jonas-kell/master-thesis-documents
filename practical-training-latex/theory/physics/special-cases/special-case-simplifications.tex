...
\newpage % TODO check newpage justified in final render
...
\vspace{1cm}
All presented simplifications to the Hamiltonians and corresponding MC-modification strategies in this section are implemented as options that are selectable in the control-script   
