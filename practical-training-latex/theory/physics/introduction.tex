...
The time-evolution will be made by employing an expansion in the Interction Picture to first degree, which results in a computational complexity of \bigo{n^2} per evaluated state in the worst case. 
