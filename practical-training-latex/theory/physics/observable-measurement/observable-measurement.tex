...
Overall, the evaluation of this observable requires knowing the value of an object of the form presented in \autoref{eq:form-kinteic-obs}.

\begin{equation}
    \label{eq:form-kinteic-obs}
...
It is finally important to notice, that the objects from \autoref{eq:form-kinteic-obs} are not real-valued, but complex.
