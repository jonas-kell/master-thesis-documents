...
\begin{frame}
    ...
    \begin{columns}
        ...
        \column{0.4\textwidth}
            \onslide<1->
            \makebox[\textwidth][c]{\includegraphics[page=1,width=.9\textwidth]{./main-content/paper/V_interaction_picture.pdf}}
            \vspace{0.3em}
            \onslide<2->
            \makebox[\textwidth][c]{\includegraphics[page=2,width=.9\textwidth]{./main-content/paper/V_interaction_picture.pdf}}
    ...
    \note[item] {
        How to time-evolve operator in the Interaction Picture
        $\left\{\cdot\right\}(t) = e^{i H_0 t}\left\{\cdot\right\}e^{-i H_0 t}$
    }
\end{frame}
