...
\begin{frame}
    ...
    \begin{columns}
        ...
        \column{0.5\textwidth}
            \makebox[\textwidth][c]{\includegraphics[width=.8\textwidth]{./main-content/physics/geometry.pdf}}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \column{0.5\textwidth}
            \makebox[\textwidth][c]{\includegraphics[page=1,width=.7\textwidth]{./main-content/physics/rewrite.pdf}}
            \makebox[\textwidth][c]{\includegraphics[page=2,width=.7\textwidth]{./main-content/physics/rewrite.pdf}}
            \makebox[\textwidth][c]{\includegraphics[page=3,width=.7\textwidth]{./main-content/physics/rewrite.pdf}}
