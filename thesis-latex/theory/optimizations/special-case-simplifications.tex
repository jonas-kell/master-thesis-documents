...
As stated in \fullref{sec:theory-optimizations-monte-carlo} it is also needed to compute the transition probability between two sampled states in \autoref{eq:transition-probability-final}.
