...
How this could be done, can be looked up in the implementation \filepath{\cite{selfCode}}{/computation-scripts/hamiltonian.py} in the specialization class \emph{FirstOrderCanonicalHamiltonian}.
...
See \filepath{\cite{selfCode}}{/calculation-helpers/generatesecondorder.py}.
