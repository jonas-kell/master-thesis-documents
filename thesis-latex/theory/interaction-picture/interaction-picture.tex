...
Plugging this into the rearranged result from \autoref{eq:time-evolution-target} following the derivation in \cite{variationalClassicalNetworksPaper} and \cite{isingDynamicsWithClassicalNetworks}, one obtains an expansion for \HNOft in \autoref{eq:cumulant-expansion}.
