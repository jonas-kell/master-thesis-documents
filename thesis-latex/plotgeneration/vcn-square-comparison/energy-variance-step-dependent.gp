...
plot \
     ...
     "comparevcn100-exact-energy.csv"       using ($1 * U):($2/U) notitle      axis x1y1 with linespoints pointtype 16 pointsize 0.8 linecolor rgb markermint, \
     "comparevcn200-exact-energy.csv"       using ($1 * U):($2/U) notitle      axis x1y1 with linespoints pointtype 16 pointsize 0.8 linecolor rgb markerpink
# end plot 1,1
...
plot \
     ...
     NaN with points pt 5 pointsize 0.6 lc rgb markermint      title " VCN int. 100", \
     NaN with points pt 5 pointsize 0.6 lc rgb markerpink      title " VCN int. 200", \
     ...
     "comparevcn100-exact-variance.csv"       using ($1 * U):($2/U) notitle      axis x1y1 with linespoints pointtype 16 pointsize 0.8 linecolor rgb markermint, \
     "comparevcn200-exact-variance.csv"       using ($1 * U):($2/U) notitle      axis x1y1 with linespoints pointtype 16 pointsize 0.8 linecolor rgb markerpink
# end plot 2,1
