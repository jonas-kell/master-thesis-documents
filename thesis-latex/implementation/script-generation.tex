...
Exemplary, each of the three \VhamiltonianPartA{N}{t}, \VhamiltonianPartB{N}{t} and \VhamiltonianPartC{N}{t} is a sum of 8 summands, as one can see in \autoref{eq:interaction-picture-v-ham-parts}.
...
The generating script \filepath{\cite{selfCode}}{/calculation-helpers/simplificationtermhelper.py} and the generated script \filepath{\cite{selfCode}}{/computation-scripts/analyticalcalcfunctions.py}.
